...
// 
// @require			https://greasyfork.org/scripts/5574-ikariam-core/code/Ikariam%20Core.js?version=230354
// 
// @connect			greasyfork.org
//
// 
// @resource		de					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/de.json
// @resource		gr					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/gr.json
// @resource		fr					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/fr.json
// @resource		it					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/it.json
// @resource		lv					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/lv.json
// @resource		ru					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/ru.json
// @resource		tr					https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/tr.json
...
async function main() {
	...
	var IC = new IkariamCore('4.1.0.1', 4369, 'Ikariam Enhanced UI', 'Tobbe', false);
	...
	for(var i = 0; i < la_language.length; i++) {
		await IC.Language.registerLanguageResource(la_language[i], la_language[i], 'https://resources.ikascripts.de/IkariamEnhancedUI/v4.1.0.1/' + la_language[i] + '.json');
	}
